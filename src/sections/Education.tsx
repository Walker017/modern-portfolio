    ...
    <>
      <section className="pb-5 w-full bg-gray-950" id="education">
        ...
        <div className="mx-6 pt-8 md:mx-10">
          <TimelineItem title="Elementaire">
            Studied Grade 1-6 at Balighot Elementary School (115550)
          </TimelineItem>
          <TimelineItem title="communauté school">
            Studied Grade 7 at Florentina B. communauté school (302404)
          </TimelineItem>
          <TimelineItem title="chatgpt school">
            Studied Grade 8-10 at Sto. Cristo National Chatgpt School (307509)
          </TimelineItem>
        </div>
      </section>
    </>
